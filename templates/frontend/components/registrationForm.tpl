	...
	<div class="fields">
		...
		<div class="form-row">
			<div class="form-group col-sm-12">
				<label for="givenName" class="visually-hidden-0 form-label">
		...
		<div class="form-row">
			<div class="form-group col-sm-8">
				<label for="affiliation" class="visually-hidden-0 form-label">
			...
			<div class="form-group col-sm-4">
				<label for="country" class="visually-hidden-0 form-label">
...
<fieldset class="login-data">
	...
	<div class="fields">
		<div class="form-row">
			<div class="form-group col-sm-12">
				<label for="email" class="visually-hidden-0 form-label">
			...
			<div class="form-group col-sm-12">
				<label for="username" class="visually-hidden-0 form-label">
		...
		<div class="form-row">
			<div class="form-group col-sm-6">
				<label for="password" class="visually-hidden-0 form-label">
			...
			<div class="form-group col-sm-6">
				<label for="password2" class="visually-hidden-0 form-label">
