	...
	<div class="issue-top-wrap">
		{* Article/Issue cover image *}
			{if $publication->getLocalizedData('coverImage') || ($issue && $issue->getLocalizedCoverImage())}
				<div class="article_cover_wrapper img-wrap">
...
{* 			<a href="#" class="btn btn-full">Read online</a>
			<a href="#" class="btn btn-pdf">PDF</a> *}
		</div>
	</div>
	<div class="issue-block">
		{* article title and subtitle *}
		<h1 class="page_title article-full-title b-title">
			{$publication->getLocalizedFullTitle(null, 'html')|strip_unsafe_html}
		</h1>
		{* {$section->getLocalizedTitle()} *}
		{if $issue}
			<div class="article_issue_credentials t-title">
		...
		{* Publication & update dates; previous versions *}
    		...
    		<p>
      			<b>{translate key="submissions.published"}</b>
		...
		<div class="authors-block">
			{* <div class="author"><a href="#">Name Surname</a>,</div>
			<div class="author"><a href="#">Name Surname</a></div> *}
		</div>
		<div class="t-title">DOI link:</div>
		{* DOI (requires plugin) *}
			{foreach from=$pubIdPlugins item=pubIdPlugin}
				...
				{if $pubId}
					...
					<div class="doi">
						...
						<span class="doi_value doi-link txt">
							<a href="{$doiUrl}">
				...
				{/if}
			{/foreach}
		{* <div class="doi-link txt"><a href="https://doi.org/10.48010/2022.2/1999-5849.01">https://doi.org/10.48010/2022.2/1999-5849.01</a></div> *}
		...
		{* Keywords *}
			...
			<div class="item keywords">
				...
				<ul class="keywords_value keywords txt">
		...
		{* <div class="citation txt">Filatov, V. (2021). FROM THE RIDDLE OF LIFE TO THE RIDDLE OF CONSCIOUSNESS. Al-Farabi, 78(2), 3–14. https://doi.org/10.48010/2022.2/1999-5911.01</div> *}
		<div class="annotation-wrap">
			...
			{if $publication->getLocalizedData('abstract')}
				<div class="abstract">
					<h2 class="b-title">{translate key="article.abstract"}</h2>
